...
# Lecture 4 (maximum subarray and related problems)
...
Multiply(A, B):
  n <- size of A
  if n = 1 then return A[1] * B[1]
  mid <- floor(n/2)
  𝑈 <- Multiply(𝐴[𝑚𝑖𝑑+1..𝑛],𝐵[𝑚𝑖𝑑+1..𝑛])    // 𝑎1𝑏1
  𝑉 <- Multiply(𝐴[𝑚𝑖𝑑+1..𝑛],𝐵[1..𝑚𝑖𝑑])       // 𝑎1𝑏0
  𝑊 <- Multiply(𝐴[1..𝑚𝑖𝑑],𝐵[𝑚𝑖𝑑+1..𝑛])      // 𝑎0𝑏1
  𝑍 <- Multiply(𝐴[1..𝑚𝑖𝑑],𝐵[1..𝑚𝑖𝑑])
  M[1..2n] <- 0
  M[1..n] <- Z\
  𝑀[𝑚𝑖𝑑+1..] <- 𝑀[𝑚𝑖𝑑+1..] ⨁𝑉⨁𝑊            // + (𝑎1𝑏0+𝑎0𝑏1)≪𝑛/2 
  M[2𝑚𝑖𝑑+1..] <- 𝑀[2𝑚𝑖𝑑+1..] ⨁𝑈             // + 𝑎1𝑏1≪𝑛 
  return M
````